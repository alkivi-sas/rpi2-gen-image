...
# Salt dependencies
chroot_exec apt-get install -y --force-yes python resolvconf python-crypto python-msgpack python-zmq python-dateutil python-jinja2 python-apt python-yaml python-pkg-resources python-requests dctrl-tools wget python-pycurl libcurl3-gnutls python-backports.ssl-match-hostname python-singledispatch bsdmainutils vim
